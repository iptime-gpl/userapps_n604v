...
ifneq ($(USE_PORT_LINKSETUP_24PORTS),y)
	@rm -f $(JS_ROOT)/trafficconf_linksetup_24ports.js
endif
ifneq ($(USE_SNMPD),y)
	@rm -f $(JS_ROOT)/snmp.js
endif

ifneq ($(USE_DUAL_WAN), y)
	@rm -f $(JS_ROOT)/trafficconf_lspolicy.js
	@rm -f $(JS_ROOT)/trafficconf_lsrule.js
	@rm -f $(JS_ROOT)/trafficconf_loadshare.js
else
ifneq ($(USE_STRATEGY_ROUTING), y)
	@rm -f $(JS_ROOT)/trafficconf_lspolicy.js
	@rm -f $(JS_ROOT)/trafficconf_lsrule.js
else
	@rm -f $(JS_ROOT)/trafficconf_loadshare.js
...
ifneq ($(USE_TOP_MENU_SWITCH_CONFIG),y)
	@rm -f $(JS_ROOT)/switchconf_vlan.js
endif
ifeq ($(USE_PORT_QOS),y)
	@rm -f $(JS_ROOT)/trafficconf_qos.*
endif
# JS Section End	
