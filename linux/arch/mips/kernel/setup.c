...
unsigned int is8196C;
unsigned int isRTL8196C_REV_A;
/*
 * Setup information
 *
...
#if defined(CONFIG_RTL8196B_KLD) || defined(CONFIG_RTL8196C_KLD) || defined(CONFIG_RTL8192CD) || defined(CONFIG_RTL_8196D) ||  defined(CONFIG_RTL_8196E_KLD)
	{
		extern void force_stop_wlan_hw(void);
		force_stop_wlan_hw();
	}
#elif defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8196C_8196E)
	{
		if(IS_RTL8196E)
		{
			extern void force_stop_wlan_hw(void);
...
#else //#if CONFIG_WIRELESS_LAN_MODULE
	extern int gCpuCanSuspend;
	if (!gCpuCanSuspend)
            return;
#endif //#if CONFIG_WIRELESS_LAN_MODULE
#endif //#ifndef CONFIG_RTL8197B_PANA
#endif //#ifdef CONFIG_NET_WIRELESS_AGN
#endif //#ifndef CONFIG_RTL8196C
#endif //#ifdef CONFIG_RTL8196B //michaelxxx

#if defined(CONFIG_RTL8196C) || defined(CONFIG_RTL_8196C_8196E) //michaelxxx
...
init_arch(int argc, char **argv, char **envp, int *prom_vec)
{
	...
	typedef unsigned int uint32;
	//extern unsigned int is8196C;
	is8196C = (unsigned int)IS_RTL8196C;
	isRTL8196C_REV_A = (unsigned int)(REG32(REVR) == RTL8196C_REVISION_A);
	start_kernel();
}
