...
#if defined(CONFIG_RTL865X) || defined(CONFIG_RTL8196B) || defined(CONFIG_RTL8198) ||  defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8196C_8196E)
...
#if defined(CONFIG_RTL8196B)|| defined(CONFIG_RTL8198) ||  defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8196C_8196E)
...
struct irqRoute_t irqRoute_96c[]={
...
struct irqRoute_t irqRoute_96e[]={
...
#if defined(CONFIG_RTL865X) || defined(CONFIG_RTL8196B)|| defined(CONFIG_RTL8198) || defined(CONFIG_RTL_8196D) ||  defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8196C_8196E)
#define ALLINTS (IE_IRQ0 | IE_IRQ1 |IE_IRQ2 | IE_IRQ3 | IE_IRQ4 | IE_IRQ5)
#endif

static inline int unmask_irq_96c(unsigned int irq)
{	
  #if defined(CONFIG_RTL_8196C_8196E) || defined(CONFIG_RTL_8196C)
	if (irq == PCIE_IRQ_96C) {
...
static inline int unmask_irq_96e(unsigned int irq)
{
	if (irq == PCIE_IRQ_96E) {
      REG32(GIMR) = (REG32(GIMR)) | PCIE_IE;
...
#if defined(CONFIG_RTL8196B)|| defined(CONFIG_RTL8198) || defined(CONFIG_RTL_8196D) ||  defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8196C_8196E)

#if defined(CONFIG_RTL_8196C_8196E)
	if(is8196C)
	{
		if(unmask_irq_96c(irq))
			return;  
	}
	else
	{
		if(unmask_irq_96e(irq))
			return;
	}
  ...
  if(unmask_irq_96e(irq))
	...
	if(!is8196C)
	{
		...
		if ( (irq == 0) || (irq == 1) || (irq == 6) )
			REG32(IRR2)|= ((irqRoute_96e[irq].idx & 0xF)<<irqRoute_96e[irq].base);
		//else
		else if (irq < 10) //RTL8196B, michael, irqRoute array has only 10 elements
			REG32(IRR1)|= ((irqRoute_96e[irq].idx & 0xF)<<irqRoute_96e[irq].base);
	}
...
static struct hw_interrupt_type irq_type = {
 ...
 #if defined(CONFIG_RTL_8196C_8196E) || defined(CONFIG_RTL_8196C)
static void irq_dispatch_96c(struct pt_regs *regs, unsigned int irq_x)
{
	if( irq_x & 0x00004000)
	{
		do_IRQ(9, regs); //Timer
...
static void irq_dispatch_96e(struct pt_regs *regs, unsigned int irq_x)
{
	if( irq_x & 0x00000100)
	{
		do_IRQ(9, regs); //Timer
...
#if defined(CONFIG_RTL865X) || defined(CONFIG_RTL8196B) || defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8196C_8196E)
...
#if defined(CONFIG_RTL_8196C_8196E)
		if(is8196C)
			irq_dispatch_96c(regs, irq_x);
		else
			irq_dispatch_96e(regs, irq_x);
...
#if defined(CONFIG_RTL8198) ||  defined(CONFIG_RTL_8196D) ||  defined(CONFIG_RTL8196C) ||  defined(CONFIG_RTL_8196E) /*michaelxxx */ || defined(CONFIG_RTL_8196C_8196E)
...
#if defined(CONFIG_RTL_8196C_8196E)	
	if(is8196C)
		wlan_int_count[index] = kstat_irqs(PCIE_IRQ_96C);
	else
		wlan_int_count[index] = kstat_irqs(PCIE_IRQ_96E);
#elif defined(CONFIG_RTL8196C)
	wlan_int_count[index] = kstat_irqs(PCIE_IRQ_96C);
#elif defined(CONFIG_RTL_8196E)
	wlan_int_count[index] = kstat_irqs(PCIE_IRQ_96E);
