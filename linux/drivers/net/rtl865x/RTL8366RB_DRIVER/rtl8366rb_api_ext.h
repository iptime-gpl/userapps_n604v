...
* $Id: rtl8366rb_api_ext.h,v 1.1.1.1 2010/06/15 01:48:52 ysyoo Exp $
*/
...
/* RTCT */
extern int32 rtl8366rb_setRtctTesting(enum PORTID port);
extern int32 rtl8366rb_getRtctResult(enum PORTID port,enum CHANNELID channel, uint32* length, uint32* impmis, uint32* openSts, uint32* shortSts);
