...
* All rights reserved.
* 
* $Header: /usr/kcvsrep/rtl8196c/rtl8196c-sdk_1.2/rtl8196c-linux-1.2/linux-2.4.18/drivers/net/rtl865x/swCore.h,v 1.3 2014/07/21 05:41:13 rtlwl Exp $
*
...
*
* $Log: swCore.h,v $
* Revision 1.3  2014/07/21 05:41:13  rtlwl
* 1.2m patched
*
* Revision 1.6.2.2  2011/05/05 02:20:18  keith_huang
* When play ipv6 mld, vlc client will receive two data in bridge mode
*
* Revision 1.6.2.1  2010/11/29 03:27:10  keith_huang
* Add ipv6 pass throuth supported
*
* Revision 1.6  2010/04/19 05:45:33  joeylin
* fix the SUPPORT_IPV6_MLD and CONFIG_RTK_VLAN_SUPPORT conflict issue
*
* Revision 1.5  2010/04/08 03:23:23  pluswang
* IPV6 MLD will confict with VLAN now ,need fix in the future
*
...
#undef CONFIG_RTL865X_SUPPORT_IPV6_MLD
#endif
#endif
/* --------------------------------------------------------------------
