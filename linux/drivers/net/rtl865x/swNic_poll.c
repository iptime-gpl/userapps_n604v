...
* All rights reserved.
* 
* $Header: /usr/kcvsrep/rtl8196c/rtl8196c-sdk_1.2/rtl8196c-linux-1.2/linux-2.4.18/drivers/net/rtl865x/swNic_poll.c,v 1.4 2014/07/21 05:41:13 rtlwl Exp $
*
...
*
* $Log: swNic_poll.c,v $
* Revision 1.4  2014/07/21 05:41:13  rtlwl
* 1.2m patched
*
                 ...
                 uint32 clusterSize)
{
	...
	struct pktHdr * pPkthdr;
	struct mBuf * pMbuf;
	volatile unsigned int cpuVer = REG32(REVR);
...
#if defined(CONFIG_RTL8196C_REVISION_B) || defined(CONFIG_RTL_8196C_8196E)
			//if (REG32(REVR) == RTL8196C_REVISION_A)
			if (cpuVer== RTL8196C_REVISION_A) {
				panic_printk("sdfsdfsdf\n\n\n");
...
#if defined(CONFIG_RTL_8196D) || defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL8196C) || defined(CONFIG_RTL_8196C_8196E)
...
#if defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8196C_8196E) // Joey_add, CPUTPDCR2 & CPUTPDCR3 are for 8196E hardware only
		if(IS_RTL8196E)
		{
			REG32(CPUTPDCR2) = (uint32) txPkthdrRing[2];
			REG32(CPUTPDCR3) = (uint32) txPkthdrRing[3];
