...
#if defined(CONFIG_RTL8196C) || defined(CONFIG_RTL_8196C_8196E)//|| defined(CONFIG_RTL8198) || defined(CONFIG_RTL_8196D)
...
#else // #if defined(CONFIG_RTL8196B_GW_8M)	
	#define ETH_REFILL_THRESHOLD	90 // 24	// must < NUM_RX_PKTHDR_DESC  0315 jasonwang
#endif	//#if defined(CONFIG_RTL8196B_GW_8M)
...
#define __IRAM_SECTION_	__attribute__ ((section(".iram-fwd")))
#define __DRAM_SECTION_	__attribute__ ((section(".dram-fwd")))
#define __CE_MISS			__attribute__ ((section(".CE-MISS")))
#endif
...
#else	// RTL8196B // RTL8198, 8196D, 8196E
//#define CONFIG_RTK_CHECK_ETH_TX_HANG		1
#endif
...
#define V6_DHCPV6_PROTO(mac)		( (mac[54]==0x02) && (mac[55]==0x22)&& (mac[56]==0x02) && (mac[57]==0x23))
