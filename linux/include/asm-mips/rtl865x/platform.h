...
#define DMT_IRQ         24
#define PCIE2_IRQ       22
#define PCIE_IRQ_96C    10
#define PCIE_IRQ_96E	21
//#define GDMA_IRQ_96C    11
//#define GDMA_IRQ_96E    23
#define SECURITY_IRQ    20
#define PCM_IRQ         19
#define HCI_IRQ         18
#define GPIO_EFGH_IRQ   17
//#define GPIO_ABCD_IRQ_96C 9
//#define GPIO_ABCD_IRQ_96E 16
//#define SW_IRQ_96C      8
//#define SW_IRQ_96C      15
#define PCI_IRQ         14
#define UART1_IRQ       13
//#define UART0_IRQ_96C	7
//#define UART0_IRQ_96E	12
#define USB_D_IRQ       11
#define USB_H_IRQ       10
//#define TC1_IRQ_96C		15
//#define TC1_IRQ_96E		9
//#define TC0_IRQ_96C		14
//#define TC0_IRQ_96E		8
//#define LBCTMOm2_IRQ_96C	1
//#define LBCTMOm2_IRQ_96E	7
...
#define DMT_IRQ         24
#define PCIE2_IRQ       22
#define PCIE_IRQ_96C        10//21  // shall be 22
...
#elif defined(CONFIG_RTL8198) || defined(CONFIG_RTL_8196E)
...
#define DMT_IRQ         24
#define PCIE2_IRQ       22
#define PCIE_IRQ_96E        21  // shall be 22
#define GDMA_IRQ        23
#define SECURITY_IRQ    20
#define PCM_IRQ         19
#define HCI_IRQ         18
...
#define GIMR            0xB8003000
   ...
   #define PCIE_IE 		 ( IS_RTL8196C?(1 << 10):(1 << 21) ) //96c:96e
   #define GDMA_IE         (1 << 23)
   #define SECURITY_IE     (1 << 20)
   #define PCM_IE          (1 << 19)
   #define HCI_IE          (1 << 18)
   #define GPIO_EFGH_IE    (1 << 17)
   #define GPIO_ABCD_IE    ( IS_RTL8196C?(1 << 9):(1 << 16) ) //96c:96e
   #define SW_IE       		 ( IS_RTL8196C?(1 << 8):(1 << 15) ) //96c:96e
   #define PCI_IE          (1 << 14)
   #define UART1_IE        (1 << 13)
   #define UART0_IE        ( IS_RTL8196C?(1 << 7):(1 << 12) ) //96c:96e
   #define USB_D_IE        (1 << 11)
   #define USB_H_IE        (1 << 10)
   #define TC1_IE          ( IS_RTL8196C?(1 << 15):(1 << 9) ) //96c:96e
   #define TC0_IE          ( IS_RTL8196C?(1 << 14):(1 << 8) ) //96c:96e
...
//   #define PCIB1TO_IE      (1 << 1)
   ...
   #define PCIE_IP         ( IS_RTL8196C?(1 << 10):(1 << 21) ) //96c:96e
   #define GDMA_IP         (1 << 23)
   #define SECURITY_IP     (1 << 20)
   #define PCM_IP          (1 << 19)
//   #define HCI_IP          (1 << 18)
   #define GPIO_EFGH_IP    (1 << 17)
   #define GPIO_ABCD_IP    ( IS_RTL8196C?(1 << 9):(1 << 16) ) //96c:96e
   #define SW_IP           ( IS_RTL8196C?(1 << 8):(1 << 15) ) //96c:96e
   #define PCI_IP          (1 << 14)
   #define UART1_IP        (1 << 13)
   #define UART0_IP        ( IS_RTL8196C?(1 << 7):(1 << 12) ) //96c:96e
   #define USB_D_IP        (1 << 11)
   #define USB_H_IP        (1 << 10)
   #define TC1_IP          ( IS_RTL8196C?(1 << 15):(1 << 9) ) //96c:96e
   #define TC0_IP          ( IS_RTL8196C?(1 << 14):(1 << 8) ) //96c:96e
...
#define IRR0_SETTING		(IS_RTL8196C?((UART0_RS << 28) | \
                         (LBCTMOm1_RS << 24) | \
                         (SPEED_RS    << 20) | \
                         (LBCTMOs0_RS << 16) | \
                         (LBCTMOm0_RS << 12) | \
...
#define IRR1_SETTING 		  (IS_RTL8196C?((SW_RS << 0) | \
	                         (PCIE_RS  << 8) | \
	                         (UART1_RS << 20) | \
	                         (OCPTMO_RS << 16) | \
	                         (GDMA_RS << 12) | \
...
#define IS_RTL8196C			( (REG32(REVR)&0xFFFFF000) == 0x80000000 ? 1:0)
	
#if defined(CONFIG_RTL_8196C) || defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8196C_8196E)
#define BSP_RTL8196E            0x8196E000
#define IS_RTL8196E			( (REG32(REVR)&0xFFFFF000) == BSP_RTL8196E ? 1:0)
#endif
