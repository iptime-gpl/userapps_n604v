...
* All rights reserved.
* 
* $Header: /usr/kcvsrep/rtl8196c/rtl8196c-sdk_1.2/rtl8196c-linux-1.2/linux-2.4.18/include/asm-mips/rtl865x/rtl865xc_asicregs.h,v 1.2 2014/08/07 05:15:11 rtlwl Exp $
*
...
#define TOGGLE_BIT_IN_REG(reg, bit_shift) \
 	if(IS_RTL8196C){\
 		(WRITE_MEM32(reg, READ_MEM32(reg) ^ bit_shift));\
 	}
...
#if defined(CONFIG_RTL_8198) || defined(CONFIG_RTL_819XD) || defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8196C_8196E)
