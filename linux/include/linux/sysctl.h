...
enum
{
	...
	NET_IPV4_NF_CONNTRACK_ALG_FTP,
	#endif
	#ifdef CONFIG_IP_NF_H323
	NET_IPV4_NF_CONNTRACK_ALG_H323,
	#endif
	#ifdef CONFIG_IP_NF_AMANDA
	NET_IPV4_NF_CONNTRACK_ALG_AMANDA,
	#endif
	#ifdef CONFIG_IP_NF_TFTP
	NET_IPV4_NF_CONNTRACK_ALG_TFTP,
	#endif
	#ifdef CONFIG_IP_NF_IRC
	NET_IPV4_NF_CONNTRACK_ALG_IRC,
	#endif
	#ifdef CONFIG_IP_NF_PPTP
	NET_IPV4_NF_CONNTRACK_ALG_PPTP,
	#endif
	#ifdef CONFIG_IP_NF_IPSEC
	NET_IPV4_NF_CONNTRACK_ALG_IPSEC,
	#endif
	#ifdef CONFIG_IP_NF_SIP
	NET_IPV4_NF_CONNTRACK_ALG_SIP,
	#endif
#endif
};
