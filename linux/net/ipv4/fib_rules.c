 ...
 *
 * Version:	$Id: fib_rules.c,v 1.1.1.1 2010/06/15 01:48:41 ysyoo Exp $
 *
...
void __init fib_rules_init(void)
{
	...
	//memcpy(0x90000000, &local_rule, sizeof(struct fib_rule));
	//fib_rules = (struct fib_rules *)(0x90000000);
#endif	
