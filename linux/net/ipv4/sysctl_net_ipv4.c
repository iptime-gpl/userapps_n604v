 ...
 *
 * $Id: sysctl_net_ipv4.c,v 1.2 2010/06/28 02:17:11 ysrtl Exp $
 *
...
/* Should be defined here, or it may cause linking error when config CONNTRACK as a module
 * John Ho add for looseUDP support [default = off] -- 03/19/2004
 */
...
extern int sysctl_forward_speed_up_flag;
#endif
#ifdef CONFIG_PASSTHROUGH_ALL_CHAIN
extern int sysctl_nat_passthrough_flag;
#endif
...
#endif
#ifdef CONFIG_IP_NF_LOOSEUDP
	/* John Ho add to support looseUDP */
	{NET_IPV4_MASQ_UDP_DLOOSE, "ip_masq_udp_dloose",
...
#endif
#ifdef CONFIG_FORWARD_SPEED_UP_PATCH
	{NET_FORWARD_SPEED_UP_FLAG, "forward_speed_up_flag",
	&sysctl_forward_speed_up_flag, sizeof(int), 0644, NULL, &proc_dointvec},
#endif
#ifdef CONFIG_PASSTHROUGH_ALL_CHAIN
	{NET_NAT_PASSTHROUGH, "nat_passthrough_flag",
	&sysctl_nat_passthrough_flag, sizeof(int), 0644, NULL, &proc_dointvec},
#endif
#if defined(CONFIG_IP_NF_NAT_ISPFAKE) || defined(CONFIG_IP_NF_NAT_ISPFAKE_MODULE)
	{NET_TCP_MSS_ISPFAKE, "tcp_mss_ispfake",
	 &sysctl_tcp_mss_ispfake, sizeof(int), 0644, NULL, &proc_dointvec},
#endif
...
EXPORT_SYMBOL(sysctl_tcp_app_win);
#endif
#endif /* CONFIG_SYSCTL */
