 ...
 *
 * Version:	$Id: route.c,v 1.3 2010/12/15 09:20:26 rtlwl Exp $
 *
...
static inline void rt_drop_zero_refcnt() {
	int i;
	...
	printk(KERN_WARNING "no 0 refcnt dst 0\n");
}
#endif
