 ...
 *
 * Version:	$Id: fib_semantics.c,v 1.1.1.1 2010/06/15 01:48:41 ysyoo Exp $
 *
...
#if defined(CONFIG_RTL865X_AC) || defined(CONFIG_RTL865X_KLD) || defined(CONFIG_RTL8196B_KLD) || defined(CONFIG_RTL8186_TR) || defined(CONFIG_RTL8196B_TR) || defined(CONFIG_RTL8196C_KLD) || defined(CONFIG_RTL8196C_EC)//Brad add to support x.y.z.255 when C class ip address 20080516
