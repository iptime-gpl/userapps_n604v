 ...
 *
 * $Id: sch_htb.c,v 1.2 2014/08/07 05:13:54 rtlwl Exp $
 */
...
#if defined(CONFIG_RTL_KERNEL_MIPS16_SCHED) && defined(CONFIG_RTL_8196C_8196E)
__NOMIPS16
#elif defined(CONFIG_RTL_KERNEL_MIPS16_SCHED) && defined(CONFIG_RTL8196C)
__NOMIPS16
#endif
